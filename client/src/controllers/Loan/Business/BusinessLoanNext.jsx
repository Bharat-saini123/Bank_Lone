...
const BusinessApplyLoanNext = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${ServerApi}/api/file/uploadBusiness`, {
        method: "POST",
        body: form,
        headers: {
          token: `Barear ${token}`,
        ...
        <Form className="main-form" style={{ marginTop: "2rem" }}>
          ...
          <Div className="main-item">
              <Item className="inputs">
                <Label htmlFor="employeeType" className="labels">
                  Employee Type
                </Label>
                <Input
                  className="input"
            ...
            <Div className="main-item">
              <Item className="inputs">
                <Label htmlFor="referenceName1" className="labels">
                  Reference (Name1)
                </Label>
                <Input
                  className="input"
            ...
            <Div className="main-item">
              <Item className="inputs">
                <Label htmlFor="referenceMobileNumber1" className="labels">
                  Reference (Mobile Number1)
                </Label>
                <Input
                  className="input"
                  type="number"
            ...
            <Div className="main-item">
              <Item className="inputs">
                <Label htmlFor="referenceName2" className="labels">
                  Reference (Name2)
                </Label>
                <Input
                  className="input"
            ...
            <Div className="main-item">
              <Item className="inputs">
                <Label htmlFor="referenceMobileNumber2" className="labels">
                  Reference (Mobile Number2)
                </Label>
                <Input
                  className="input"
                  type="number"
            ...
            <Div className="main-item" style={{ display: "flex", gap: "1rem" }}>
              <Button
                ...
                onClick={()=>navigate("/businessLoneDrawer")}
              >
                Back
              </Button>
              <Button
...
export default BusinessApplyLoanNext;
